...
Level_One_DF = spark.sql("select 'Spring Mobile' as company_cd, a.id as category_Id, a.desc as category_name, a.desc as category_desc, "
                          + "a.Parentid as parent_category_id, "
                          + "case when length(a.id)/2 = '1' then a.id else ' ' end as level_one_id, "
						  + "case when length(a.id)/2 = '1' then a.desc else ' ' end as level_one_name, "
...
Level_Two_DF = spark.sql("select 'Spring Mobile' as company_cd, a.id as category_Id, a.desc as category_name, a.desc as category_desc, "
                          + "a.Parentid as parent_category_id, "
...
Level_Three_DF = spark.sql("select 'Spring Mobile' as company_cd, a.id as category_Id, a.desc as category_name, a.desc as category_desc, "
                          + "a.Parentid as parent_category_id, "
...
Level_Four_DF = spark.sql("select 'Spring Mobile' as company_cd, a.id as category_Id, a.desc as category_name, a.desc as category_desc, "
                          + "a.Parentid as parent_category_id, "
...
Level_Five_DF = spark.sql("select 'Spring Mobile' as company_cd, a.id as category_Id, a.desc as category_name, a.desc as category_desc, "
                          + "a.Parentid as parent_category_id, "
...
Level_Six_DF = spark.sql("select 'Spring Mobile' as company_cd, a.id as category_Id, a.desc as category_name, a.desc as category_desc, "
                          + "a.Parentid as parent_category_id, "
...
Level_Seven_DF = spark.sql("select 'Spring Mobile' as company_cd, a.id as category_Id, a.desc as category_name, a.desc as category_desc, "
                          + "a.Parentid as parent_category_id, "
...
Level_Eight_DF = spark.sql("select 'Spring Mobile' as company_cd, a.id as category_Id, a.desc as category_name, a.desc as category_desc, "
                          + "a.Parentid as parent_category_id, "
...
Level_Nine_DF = spark.sql("select 'Spring Mobile' as company_cd, a.id as category_Id, a.desc as category_name, a.desc as category_desc, "
                          + "a.Parentid as parent_category_id, "
...
Level_Ten_DF = spark.sql("select 'Spring Mobile' as company_cd, a.id as category_Id, a.desc as category_name, a.desc as category_desc, "
                          + "a.Parentid as parent_category_id, "
