...
Final_Joined_DF = spark.sql("select a.store_number STORE_NUM, a.dealer_codes DLR_CD, a.company_cd CO_CD, a.report_date as RPT_DT,  "
...
Final_Joined_DF.coalesce(1).select("*"). \
        ...
        option("header", "true").mode("overwrite").save(DimCnCDeliveryInput);
