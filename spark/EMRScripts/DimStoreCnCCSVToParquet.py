...
dfProductCust = spark.read.format("com.databricks.spark.csv").\
                        ...
                        load(CnCDashboardInput)
					
					
dfProductCust = dfProductCust.withColumnRenamed("Region - District - Store", "region_district_store").\
                              withColumnRenamed("Annual Compliance Courses", "annual_compliance_courses").\
                              withColumnRenamed("Monthly Initiative Trainings", "monthly_initiative_trainings").\
                              withColumnRenamed("Ongoing Learning Plan", "ongoing_learning_plan").\
                              withColumnRenamed("Overall Audit", "overall_audit").\
			 				  withColumnRenamed("Pass or Fail", "pass_or_fail")
