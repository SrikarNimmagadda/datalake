...
Final_Joined_DF = spark.sql("select a.companycd CO_CD, a.storenumber STORE_NUM, a.dealer_codes DLR_CD, a.report_date RPT_DATE, "
                          + "a.5_key_behaviors 5_KEY_BHVS, " #a.att_location_name ATT_LOC_NM, 
                          + "a.effective_solutioning EFC_SLTNING, a.integrated_experience NTGRTD_EXPRC " #'I' as CDC_IND "
