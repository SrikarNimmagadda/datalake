...
class EmpOprEffCSVToParquet(object):
    ...
    def loadParquet(self):
        ...
        df1 = self.sparkSession.read.format("com.databricks.spark.csv").option("header", "true").option("treatEmptyValuesAsNulls", "true").option("inferSchema", "false").load(OperationalEfficiencyScoreCard, schema=schema)
