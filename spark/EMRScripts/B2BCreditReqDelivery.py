...
+"a.clientname as CLNT_NM, a.ban as BAN, '' as STORE_NUM, '' as JOB_TITLE_CRDT_RQST_FOR, '' as STORE_CRDT_RQST_FOR,"
...
+"a.sourceemployeeid as EMPID_CRDT_APRV, '' as SRC_EMP_ID "
