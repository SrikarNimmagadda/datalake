...
dfSpringComm = spark.sql("select a.customeridentifier as sourceidentifier,b.companycode as companycd,'RQ4' as sourcesystemname,"
                    ...
                    + "concat(a.address1, a.address2) as address,a.city,a.stateprovince,a.zippostalcode,a.country,a.multilevelpriceidentifier,"
...
write.parquet(CompanyOutputArg + '/' + todayyear + '/' + todaymonth + '/' + 'CUSTOMERPII' + CompanyFileTime);
