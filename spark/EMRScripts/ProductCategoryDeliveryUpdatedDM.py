...
Final_joined_DF = spark.sql("select a.company_cd as CO_CD, a.category_Id as CAT_ID, a.category_name as CAT_NME, a.category_path as CAT_PATH, a.category_desc as CAT_DESC, a.parent_category_id as PARNT_CAT, "
