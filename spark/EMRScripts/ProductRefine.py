...
dfSpringComm = spark.sql("select b.companycode as companycd,a.productsku,a.productname,a.productlabel,c.CategoryNumber as categoryid,a.defaultcost,"
            ...
            + "a.backorderdate,a.storeinstoresku,a.storeinstoreprice,a.defaultdonotorder,a.defaultspecialorder,a.defaultdateeol,a.defaultwriteoff,a.noautotaxes,"
            + "'I' as cdcindicator from springcomm a cross join customer1 b"
