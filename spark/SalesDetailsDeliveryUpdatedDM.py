...
#+ "a.reportdate as RPT_DT, a.invoicedate as INVOICE_DT, '' as SRC_ID, a.sourcesystemname as SRC_SYS_NM,"
#+ "a.productserialnumber as PROD_SN, a.quantity as QTY, a.rqpriority as RQ_PRITY, a.cost as CST, a.price as PRC,"
#+ "a.rawgrossprofit as RAW_GRS_PRFT, a.serialproductid as SPCL_PROD_ID, a.saleamount as SALE_AMT, '' as CUST_SRC_ID "
#+ "from salesdetails a")

Temp_DF = spark.sql("select a.storenumber as STORE_NUM, a.companycd as CO_CD, a.invoicenumber as INVOICE_NBR,"
+ "a.lineid as LINE_ID, a.productsku as PROD_SKU,a.sourceemployeeid as SRC_EMP_ID,"
+ "a.reportdate as RPT_DT, a.invoicedate as INVOICE_DT, a.sourcesystemname as SRC_SYS_NM,"
+ "a.productserialnumber as PROD_SN, a.quantity as QTY, a.rqpriority as RQ_PRITY, a.cost as CST, a.price as PRC,"
+ "a.rawgrossprofit as RAW_GRS_PRFT, a.serialproductid as SPCL_PROD_ID, a.saleamount as SALE_AMT, '' as CUST_SRC_ID "
+ "from salesdetails a")
